    ...
    public class PaymentViewService : IPaymentViewService
    {
            ...
            bool isAuthenticated)
        {
            ...
            if (payment.PaymentMethod != null)
            {
                ...
                {
                    var paymentmethodViewModel = paymentMethodViewModels.First();
                    activePaymentVm = await UpdateActivePaymentMethodAsync(new UpdatePaymentMethodParam
                    {
                        ...
                        PaymentMethodId = paymentmethodViewModel.Id,
                        PaymentProviderName = paymentmethodViewModel.PaymentProviderName,
                    }).ConfigureAwait(false);
                    paymentId = activePaymentVm.Id;
                    paymentmethodViewModel.IsSelected = true;
                }
            }
